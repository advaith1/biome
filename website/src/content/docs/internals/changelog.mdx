...
- Add [useFilenamingConvention](https://biomejs.dev/linter/rules/use-filenaming-convention) that enforces filename convention. The rule provides an option to choose a specific convention. Contributed by @Conaclos
